    ...
    return (
        <>
            <main className="max-w-7xl  mx-auto px-4 py-8 md:px-6 lg:px-8 xl:px-10 bg-white text-black">
                ...
                <p className="ml-8  md:ml-16  md:w-3/4  text-lg">We offer opportunities and support to enable you to build your dream career where you can accomplish great things and keep challenging yourself for more in an open and collaborative work culture.
                </p>
                <FormsPage />
            </main>
        </>
