    ...
    <>
      <main className="max-w-7xl  mx-auto px-4 py-8 md:px-6 lg:px-8 xl:px-10 bg-white">
        ...
        <div className="bg-black text-white ">
          <h1 className="ml-8  md:ml-16 md:pt-10 text-white md:text-4xl mb-4  md:text-left  text-4xl  md:w-1/2  font-semibold font-['Urbanist'] leading-normal md:leading-snug  ">
            Our commitment
          </h1>
          <p className="ml-8 text-white md:ml-16  md:w-3/4 text-lg">You can depend on NBS to deliver excellent services and solutions that are customized
