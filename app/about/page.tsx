  ...
  return (
    <>
      <main className="max-w-7xl  mx-auto px-4 py-8 md:px-6 lg:px-8 xl:px-10 bg-white">
        <div className="md:py-28 py-16 mb-10">
          <h1 className="ml-8  md:ml-16   text-black md:text-4xl mb-4  md:text-left  text-4xl md:w-3/4   font-semibold font-['Urbanist'] leading-normal md:leading-snug  ">
        ...
        <div className="bg-black text-white ">
          <h1 className="px-10 pt-10 md:ml-16 md:pt-10 text-white md:text-4xl mb-4  md:text-left  text-3xl  md:w-1/2  font-semibold font-['Urbanist'] leading-normal md:leading-snug  ">
            Our commitment
          </h1>
          <p className="px-10 text-white md:ml-16  md:w-3/4 text-lg">You can depend on NBS to deliver excellent services and solutions that are customized
        ...
        <div className=" grid md:grid-cols-2 sm:grid-cols-1 gap-3  bg-black text-white">
          <div className="border border-solid border-white pt-10 my-10 md:mx-16 mx-0 md:py-6 px-2">
            <h1 className=" px-10 md:ml-8  md:text-3xl mb-4  md:text-left  text-2xl  font-semibold font-['Urbanist'] leading-normal md:leading-snug  ">
              Customer Collaboration
            </h1>
            <p className="px-10  md:ml-8 mb-4 md:w-3/4 text-lg">  &quot;We are entrusted with a broad range of IT projects, solutions, and services by our diverse customer, which spans multiple industries. <br /> <br />
          ...
          <div className="border border-solid border-white pt-10 my-10 md:mx-16 md:py-6 px-2">
            <h1 className="px-10 md:ml-8 md:text-3xl mb-4  md:text-left  text-2xl  font-semibold font-['Urbanist'] leading-normal md:leading-snug  ">
              Dedicated to Your Achievements
            </h1>
            <p className="px-10 mb-4 md:ml-8  md:w-3/4 text-lg">  &quot;We are entrusted with a broad range of IT projects, solutions, and services by our diverse customer, which spans multiple industries. <br /> <br />
