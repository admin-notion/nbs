            ...
            <div>
                <main className=" max-w-7xl  mx-auto px-4 py-8 md:px-6 lg:px-8 xl:px-10 bg-white text-black">
                    ...
                    <section className="ml-8 md:ml-16  mt-10 ">
                        ...
                        <p className="pb-4 md:w-2/3 text-lg">We source the best talent to meet your specific demands, so we can ensure quality.
                        ...
                        <p className="pb-4 md:w-2/3 text-lg">We employ a sourcing strategy based on referrals.</p>
                        <p className="pb-4 md:w-2/3 text-lg">We promise to look for the ideal fit for your needs. We ensure performance and
                    ...
                    <section className="ml-8 md:ml-16  mt-10 ">
                        ...
                        <p className="md:w-2/3 text-lg">As one of the most seasoned IT staffing companies, we have a team of knowledgeable
